...
L["The Magnify module allows you to zoom in and out on the World Map using your mouse wheel. You can pan the map by clicking and dragging when zoomed in."] = true
L["Zoom Step"] = true
L["How much to zoom with each mouse wheel increment."] = true
L["Maximum Zoom"] = true
L["The maximum zoom level allowed."] = true
L["Persist Zoom Level"] = true
L["Remember your zoom level and position when reopening the same zone."] = true
L["Use Classic Party Icons"] = true
L["Use the original party member icons instead of class-colored icons."] = true
