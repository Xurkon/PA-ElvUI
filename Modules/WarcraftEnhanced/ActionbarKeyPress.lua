local enhancedEnabled = select(4, GetAddOnInfo("ElvUI_Enhanced"))
if enhancedEnabled then return end

local E = unpack(ElvUI)
local LAB = E.Libs.LAB

local KPA = E:NewModule("WarcraftEnhanced_KeyPressAnimation")
...
function KPA:Initialize()
	...
	if not E.private.enhanced or not E.private.enhanced.actionbar or not E.private.enhanced.actionbar.keyPressAnimation then
		return
	end
