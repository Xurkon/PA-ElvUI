...
function Omen:PLAYER_LOGIN()
	...
	if LDB then
		...
		-- Minimap button disabled - removed for WarcraftEnhanced
			...
			args = {
				...
				MinimapIcon = {
					...
					set = function(info, value)
						...
						-- Minimap button disabled for WarcraftEnhanced
						--if value then LDBIcon:Show("Omen") else LDBIcon:Hide("Omen") end
					end,
					hidden = function() return true end, -- Always hidden - minimap button removed for WarcraftEnhanced
				},
				IgnorePlayerPets = {
					type = "toggle",
