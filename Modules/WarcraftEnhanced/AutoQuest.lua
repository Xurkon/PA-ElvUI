-- AutoQuest Module for WarcraftEnhanced
...
local repeatableList = {
	...
	-- Ascension Profession Dailies
		-- General
		["Outlandish Threads: Netherweave Cloth"] = { {{21877, 30}}, true},
		-- Tailoring
		["Weaving A Thread: Netherweave Net"] = { {{24268, 6}}, true},
		["Weaving A Thread: Netherweave Pants"] = { {{21852, 2}}, true},
		-- Enchanting
		["Ill Gotten Goods: Malicious Nether Shard"] = { {{1203149, 5}}, true},
		-- Woodcutting
		["Powerful Planks: Green Wood Plank"] = { {{8210230, 20}}, true},
		["Powerful Planks: Soft Wood Plank"] = { {{8210231, 20}}, true},
		-- Alchemy
		["Natural Blend: Adept's Elixir"] = { {{28103, 4}}, true},
	-- Original List
