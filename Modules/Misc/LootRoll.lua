...
function M:LoadLootRoll()
	...
	-- Hook into StaticPopup to auto-confirm loot rolls if setting is enabled
	hooksecurefunc("StaticPopup_Show", function(which, ...)
		if which == "CONFIRM_LOOT_ROLL" and E.db.general.skipLootRollConfirmation then
			-- Use C_Timer to wait a tiny bit for the dialog to fully show
