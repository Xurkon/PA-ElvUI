...
WorldMapSize = {
	...
	{ -- [1]
		...
		zoneData = {
			...
			-- Ascension/WotLK micro-zones (caves, starting areas, instances)
			-- Using approximate placeholder values
			AmmenVale = {
				height = 800.0,
				width = 1200.0,
				xOffset = 9966.0,
...
for continent, zones in pairs(Astrolabe.ContinentList) do
	...
	for index, mapName in pairs(zones) do
		if not ( mapData.zoneData[mapName] ) then
			--WE HAVE A PROBLEM!!!
			-- Commented out for now - will add missing zone data later
