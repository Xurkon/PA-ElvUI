...
P.general = {
	...
	autoRoll = false,
	skipLootRollConfirmation = false,
	...
	minimap = {
		...
		configButton = true,  -- Show ElvUI config button next to minimap
		mbfControlEnabled = false,  -- When true, MinimapButtonFrame addon controls minimap buttons instead of ElvUI
		resetZoom = {
			enable = false,
			time = 3
		},
...
P.actionbar = {
	...
	auraTracker = {
		...
		font = "PT Sans Narrow",
		fontSize = 12,  -- Smaller size for better fit
		fontOutline = "OUTLINE",
		invertOutline = false, -- Use black outline by default (true = white outline)
		colorByTime = true, -- Color text based on time remaining
		-- Color presets and brightness
		colorDefaultPreset = "white",
		colorWarningPreset = "yellow",
		colorUrgentPreset = "red",
		colorDefaultBrightness = 1.0,
		colorWarningBrightness = 1.0,
		colorUrgentBrightness = 1.0,
		-- Actual RGB colors (computed from presets)
		colorDefault = {r = 1, g = 1, b = 1}, -- White (> 10s)
		colorWarning = {r = 1, g = 1, b = 0}, -- Yellow (< 10s)
		colorUrgent = {r = 1, g = 0, b = 0},  -- Red (< 5s)
		warningThreshold = 10, -- Turn warning color at X seconds
		urgentThreshold = 5,   -- Turn urgent color at X seconds
	},
