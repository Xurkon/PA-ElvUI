...
G.general = {
	...
	-- Removed worldmap settings - Using Mapster addon instead
	...
	AceGUI = {
		width = 1000,
		height = 720,
		treeWidth = 175 -- Persistent tree divider width
	}
	-- WorldMapCoordinates settings removed - Use Mapster configuration
	-- WorldMapCoordinates = {
	-- 	enable = true,
	-- 	position = "BOTTOMLEFT",
	-- 	xOffset = 0,
