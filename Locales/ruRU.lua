...
L["ElvUI is five or more revisions out of date. You can download the newest version from the Ascension Launcher, or https://github.com/Ascension-Addons/ElvUI"] = "Ваш ElvUI устарел более, чем на 5 версий. Обновите его на https://github.com/Ascension-Addons/ElvUI"
L["ElvUI is out of date. You can download the newest version from the Ascension Launcher, or https://github.com/Ascension-Addons/ElvUI"] = "ElvUI устарел. Вы можете скачать последнюю версию с https://github.com/Ascension-Addons/ElvUI"
...
L["For technical support visit us at https://github.com/Ascension-Addons/ElvUI."] = "За технической поддержкой обращайтесь на https://github.com/Ascension-Addons/ElvUI."
L["Frame"] = "Рамка"
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "Клавиша"
L["LOGIN_MSG"] = "Добро пожаловать в %sElvUI|r версии %s%s|r, наберите /ec для доступа в меню настроек. Если Вам нужна техническая поддержка, посетите наш форум на https://github.com/Ascension-Addons/ElvUI или присоединяйтесь к серверу Discord: https://discord.gg/UXSc7nt"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Ascension-Addons/ElvUI."] = "Вы завершили процесс установки. Если Вам требуется техническая поддержка, посетите сайт https://github.com/Ascension-Addons/ElvUI."
...
L["PLAYER_DIFFICULTY3"] = "мифик"
L["PLAYER_DIFFICULTY4"] = "Вознесенный"
