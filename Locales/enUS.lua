...
-- L["ElvUI is five or more revisions out of date. You can download the newest version from the Ascension Launcher, or https://github.com/Ascension-Addons/ElvUI"] = true -- VERSION CHECKS DISABLED
-- L["ElvUI is out of date. You can download the newest version from the Ascension Launcher, or https://github.com/Ascension-Addons/ElvUI"] = true -- VERSION CHECKS DISABLED
...
L["Remember Mail Recipients"] = true
L["Keep the last mail recipient entered and show a list of recent contacts."] = true
L["Recent Mail Recipients"] = true
L["Clear Recipient History"] = true
L["No stored recipients"] = true
L["Error Frame"] = true
L["Show Zone Levels"] = true
L["Display recommended character levels on the world map zone label."] = true
...
L["Trial of the Grand Crusader"] = true
L["Ulduar"] = true
L["RS"] = "Ruby Sanctum"
...
L["Profession Menu"] = true
L["Profession Menu Button"] = true
L["Left Click: Toggle Menu"] = true
L["Right Click: Move"] = true
L["Enable Profession Menu"] = true
L["Enable the profession menu button that provides quick access to all your professions."] = true
L["Enable VuhDo Skin"] = true
L["Reload UI"] = true
L["Remaining:"] = true
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/Ascension-Addons/ElvUI."] = true
