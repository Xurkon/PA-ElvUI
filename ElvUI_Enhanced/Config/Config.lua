	...
	return {
		...
		args = {
			...
			minimapButtons = {
				...
				disabled = function() return not E.private.enhanced.minimapButtonGrabber or (E.db.general.minimap and E.db.general.minimap.mbfControlEnabled) end,
				args = {
					mbfDisclaimer = {
						order = 0.5,
						type = "description",
						name = "|cffFF0000" .. L["Minimap Button Frame has current control over minimap buttons, change in ElvUI>Maps>Minimap to disable."] .. "|r",
						hidden = function() return not (E.db.general.minimap and E.db.general.minimap.mbfControlEnabled) end
					},
					enable = {
						order = 1,
						type = "toggle",
						...
						disabled = function() return (E.db.general.minimap and E.db.general.minimap.mbfControlEnabled) end
					},
					spacer = {
						order = 2,
						type = "description",
					...
					backdropSpacing = {
						...
						min = -1, max = 15, step = 1,
						disabled = function() return not E.private.enhanced.minimapButtonGrabber or not E.db.enhanced.minimap.buttonGrabber.backdrop or (E.db.general.minimap and E.db.general.minimap.mbfControlEnabled) end,
					},
					mouseover = {
						order = 9,
						type = "toggle",
					...
					insideMinimapGroup = {
						...
						disabled = function() return not E.db.enhanced.minimap.buttonGrabber.insideMinimap.enable or (E.db.general.minimap and E.db.general.minimap.mbfControlEnabled) end,
						args = {
							enable = {
								order = 1,
								type = "toggle",
