...
function LO:CreateMinimapPanels()
	...
	-- Create icon/text with better styling
	configtoggle.icon = configtoggle:CreateTexture(nil, "ARTWORK")
	configtoggle.icon:SetTexture("Interface\\Icons\\INV_Gizmo_02")  -- Gear/cog icon
	configtoggle.icon:SetPoint("CENTER")
	configtoggle.icon:SetSize(E.RBRWidth * 0.6, E.RBRWidth * 0.6)  -- 60% of button size
	configtoggle.icon:SetTexCoord(0.08, 0.92, 0.08, 0.92)  -- Crop edges for cleaner look
	
	-- Keep text as fallback/label
	configtoggle.text = configtoggle:CreateFontString(nil, "OVERLAY")
	configtoggle.text:FontTemplate(E.Libs.LSM:Fetch("font", E.db.datatexts.font), E.db.datatexts.fontSize - 2, E.db.datatexts.fontOutline)
	configtoggle.text:SetText("")  -- Hide by default, icon is better
	configtoggle.text:SetPoint("BOTTOM", configtoggle, "BOTTOM", 0, 2)
	configtoggle.text:SetJustifyH("CENTER")
	configtoggle.text:SetTextColor(0.7, 0.7, 0.7)
