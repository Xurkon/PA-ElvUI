...
L["Skip Loot Roll Confirmation"] = true
L["Loot Enhancements"] = true
L["Auto Hide"] = true
L["Auto Repair"] = true
L["Auto-Hide"] = true
L["Automatic"] = true
...
L["Skip the confirmation dialog when clicking Need, Greed, Disenchant, or Pass on loot rolls. Your selection will be immediately submitted."] = true
