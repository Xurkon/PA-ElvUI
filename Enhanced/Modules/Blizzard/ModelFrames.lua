...
function MF:ModelControlButton(model)
	...
	model.icon:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\UI-ModelControlPanel")
...
function MF:Initialize()
	...
	modelPanning.texture:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\UI-Cursor-Move")
