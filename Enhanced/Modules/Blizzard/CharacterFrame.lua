...
local PAPERDOLL_SIDEBARS = {
	...
	},
	{
		...
		icon = "Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\PaperDollSidebarTabs",
...
function module:UpdateCharacterModelFrame()
	...
	if E.db.enhanced.character.characterBackground then
		...
		CharacterModelFrame.textureTopLeft:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\"..raceEng.."_1.blp")
		CharacterModelFrame.textureTopLeft:SetDesaturated(desaturate)
		CharacterModelFrame.textureTopLeft:Show()

		CharacterModelFrame.textureTopRight:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\"..raceEng.."_2.blp")
		CharacterModelFrame.textureTopRight:SetDesaturated(desaturate)
		CharacterModelFrame.textureTopRight:Show()

		CharacterModelFrame.textureBotLeft:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\"..raceEng.."_3.blp")
		CharacterModelFrame.textureBotLeft:SetDesaturated(desaturate)
		CharacterModelFrame.textureBotLeft:Show()

		CharacterModelFrame.textureBotRight:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\"..raceEng.."_4.blp")
...
function module:UpdateInspectModelFrame()
	...
	if E.db.enhanced.character.inspectBackground then
		...
		InspectModelFrame.textureTopLeft:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\"..raceEng.."_1.blp")
		InspectModelFrame.textureTopLeft:SetDesaturated(desaturate)
		InspectModelFrame.textureTopLeft:Show()

		InspectModelFrame.textureTopRight:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\"..raceEng.."_2.blp")
		InspectModelFrame.textureTopRight:SetDesaturated(desaturate)
		InspectModelFrame.textureTopRight:Show()

		InspectModelFrame.textureBotLeft:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\"..raceEng.."_3.blp")
		InspectModelFrame.textureBotLeft:SetDesaturated(desaturate)
		InspectModelFrame.textureBotLeft:Show()

		InspectModelFrame.textureBotRight:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\"..raceEng.."_4.blp")
...
function module:UpdatePetModelFrame()
	...
	if E.db.enhanced.character.petBackground then
		...
		if E.myclass == "HUNTER" then
			PetModelFrame.petPaperDollPetModelBg:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\petHunter.blp")
			PetModelFrame.backgroundOverlay:SetAlpha(0.4)
		elseif E.myclass == "WARLOCK" then
			PetModelFrame.petPaperDollPetModelBg:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\petWarlock.blp")
			PetModelFrame.backgroundOverlay:SetAlpha(0.2)
		elseif E.myclass == "DEATHKNIGHT" then
			PetModelFrame.petPaperDollPetModelBg:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\petDeathKnight.blp")
...
function module:UpdateCompanionModelFrame()
	...
	if E.db.enhanced.character.companionBackground then
		if not CompanionModelFrame.backdrop then
			...
			CompanionModelFrame.backgroundTex:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\Media\\Textures\\backgrounds\\MountJournal-BG")
...
function module:Initialize()
	...
	if self.skinEnabled and not CharacterFrame.backdrop then
