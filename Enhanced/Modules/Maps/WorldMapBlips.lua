...
function WMB:Initialize()
	...
	for i = 1, MAX_PARTY_MEMBERS do
		...
		frame.icon:SetTexture("Interface\\Addons\\ElvUI\\Enhanced\\Media\\Textures\\PartyRaidBlips")
		frame:Size(24)
	...
	Minimap:SetClassBlipTexture("Interface\\Addons\\ElvUI\\Enhanced\\Media\\Textures\\PartyRaidBlips")
end
