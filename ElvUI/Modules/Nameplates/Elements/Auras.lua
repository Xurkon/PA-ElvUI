...
function NP:UpdateTime(elapsed)
	...
	local colors = self.timeColors or (E.db and E.db.nameplates and E.db.nameplates.cooldown and E.db.nameplates.cooldown.timeColors) or E.TimeIndicatorColors
