...
function M:UpdateSettings()
	...
	if ElvConfigToggle then
		-- Check if user disabled the config button in settings
		local showButton = E.db.general.minimap.configButton ~= false  -- Default to true if not set
		if showButton and E.db.general.reminder.enable and E.db.datatexts.minimapPanels and E.private.general.minimap.enable then
...
function M:Initialize()
	...
	Minimap:HookScript("OnMouseWheel", M.Minimap_OnMouseWheel)
	Minimap:HookScript("OnMouseUp", M.Minimap_OnMouseUp)
