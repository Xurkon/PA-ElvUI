...
TIMER_NUMBERS_SETS["BigGold"] = {
	texture = "Interface\\AddOns\\ElvUI\\Enhanced\\media\\textures\\BigTimerNumbers",
...
function TT:SetGoTexture(timer)
	if timer.type == TIMER_TYPE_PVP then
		...
		if factionGroup and factionGroup ~= "Neutral" then
			...
			timer.GoTextureGlow:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\media\\textures\\"..factionGroup.."Glow-Logo")
		end
	elseif timer.type == TIMER_TYPE_CHALLENGE_MODE then
		timer.GoTexture:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\media\\textures\\Challenges-Logo")
		timer.GoTextureGlow:SetTexture("Interface\\AddOns\\ElvUI\\Enhanced\\media\\textures\\ChallengesGlow-Logo")
