...
function mod:AddonList()
	...
	local anchorButton = GameMenuButtonRatings or GameMenuButtonMacros

	if GameMenuButtonRatings then
		GameMenuButtonRatings:HookScript("OnShow", function(frame)
			buttonAddons:Point("TOP", frame, "BOTTOM", 0, -1)
		end)

		GameMenuButtonRatings:HookScript("OnHide", function()
			buttonAddons:Point("TOP", GameMenuButtonMacros, "BOTTOM", 0, -1)
		end)
	end

	buttonAddons:Point("TOP", anchorButton, "BOTTOM", 0, -1)
