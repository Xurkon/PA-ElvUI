...
function E:CheckIncompatible()
	...
	-- Removed incompatibility check - Mapster is now the recommended map addon for ElvUI
...
function E:UpdateAll(ignoreInstall)
	...
	E:UpdateStatusBars()
	-- E:UpdateCooldownSettings("all") -- COOLDOWNS DISABLED
...
function E:Initialize()
	...
	self:LoadMovers()
	self:UpdateMedia()
	-- self:UpdateCooldownSettings("all") -- COOLDOWNS DISABLED
	self:Tutorials()
